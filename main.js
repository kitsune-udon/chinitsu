...
var $author$project$Main$tiles = $elm$core$List$concat(
	A2(
		...
		if (!msg.$) {
			return _Utils_Tuple2(
				...
				A2(
					...
					$elm_community$random_extra$Random$List$shuffle($author$project$Main$tiles)));
		} else {
			var newFace = msg.a;
			return _Utils_Tuple2(
				$elm$core$List$sort(
					A2($elm$core$List$take, 13, newFace)),
				$elm$core$Platform$Cmd$none);
		}
	});
var $author$project$Main$Shuffle = {$: 0};
...
var $author$project$Main$isChinitsu = F2(
	function (tehai, cand) {
		var gt = F3(
			function (x, i, arr) {
				var _v2 = A2($elm$core$Array$get, i, arr);
				if (!_v2.$) {
					var y = _v2.a;
					return _Utils_cmp(y, x) > 0;
				} else {
					return false;
				}
			});
		var get = F2(
			function (i, arr) {
				var _v1 = A2($elm$core$Array$get, i, arr);
				if (!_v1.$) {
					var x = _v1.a;
					return x;
				} else {
			...
			var f = function (arr) {
				return A2(
					...
					A2(
						...
						function (i) {
							return A3(gt, 2, i - 1, arr);
						},
						A2($elm$core$List$range, 1, 9)));
			};
			return $elm$core$List$concat(
				A2($elm$core$List$map, f, arrs));
		};
		var eyes = function (arr) {
			return A2(
				$elm$core$List$map,
				function (i) {
					return A3(
				...
				A2(
					$elm$core$List$filter,
					function (i) {
						return A3(gt, 1, i - 1, arr);
					},
					A2($elm$core$List$range, 1, 9)));
		};
		var counting = function (xs) {
			...
			return A2(
				...
				$elm$core$Array$toList(a)) ? $elm$core$Maybe$Nothing : $elm$core$Maybe$Just(a);
		};
		var chow = function (arrs) {
			var hasChow = F2(
				function (i, arr) {
					return (A2(get, i - 1, arr) > 0) && ((A2(get, i, arr) > 0) && (A2(get, i + 1, arr) > 0));
				});
			var decl = F2(
				function (i, arr) {
					return A3(
			...
			var f = function (arr) {
				return A2(
					$elm$core$List$map,
					function (x) {
						return A2(removeChow, x, arr);
					},
					A2(
						$elm$core$List$filter,
						function (x) {
							return A2(hasChow, x, arr);
						},
		...
		var meld = function (arrs) {
			return _Utils_ap(
				pong(arrs),
				chow(arrs));
		};
		var _v0 = counting(
			A2($elm$core$List$cons, cand, tehai));
		if (!_v0.$) {
			var a = _v0.a;
...
var $author$project$Main$machi = function (tehai) {
	return A2(
		$elm$core$List$filter,
		$author$project$Main$isChinitsu(tehai),
		A2($elm$core$List$range, 1, 9));
};
...
var $author$project$Main$toImg = function (xs) {
	var swap = function (f) {
		return F2(
			function (x, y) {
				return A2(f, y, x);
	...
	var imgurls = A2(
		$elm$core$List$map,
		A2(swap, $elm$core$Basics$append, '_1.gif'),
		A2(
			$elm$core$List$map,
			$elm$core$Basics$append('img/p_ss'),
...
var $author$project$Main$displayMachi = function (model) {
	return $author$project$Main$toImg(
		$author$project$Main$machi(model));
};
var $author$project$Main$displayTehai = function (model) {
	return $author$project$Main$toImg(model);
};
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Events$onClick($author$project$Main$Shuffle),
										$elm$html$Html$Attributes$class('col btn btn-primary')
									]),
								_List_fromArray(
									[
										A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('row card bg-light')
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										...
										$author$project$Main$displayTehai(model))
									]))
							])),
						A2(
						$elm$html$Html$div,
							...
							[
								...
								_List_fromArray(
									[
										...
										$author$project$Main$displayMachi(model))
									]))
							]))
					]))
			]),
...
var $author$project$Main$main = $elm$browser$Browser$document(
	{a3: $author$project$Main$init, bk: $author$project$Main$subscriptions, bo: $author$project$Main$update, bp: $author$project$Main$view});
